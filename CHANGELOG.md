...
- Updated Working and Draft detection for the current ChatGPT composer/stop-control DOM: aria-only stop controls such as **Detener la generación** are recognized immediately, and the new textarea name=prompt composer is tracked for Draft.
