...
- Replaced the header's letter-based counters and separate alert badge with compact colored number circles for Working, Done, Pending and Attention; zero-value counters stay hidden.
