(() => {
  ...
  function buildOverlay() {
    ...
    style.textContent =
      ...
      ".add-separator{position:relative;width:26px;height:26px;flex:0 0 auto;border:0;border-radius:7px;background:transparent;color:#7f8b9b;cursor:pointer}.add-separator[hidden]{display:none}.add-separator:hover{background:#202731;color:#d9e0e8}" +
